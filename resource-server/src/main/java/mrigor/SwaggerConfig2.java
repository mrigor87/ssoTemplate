...
public class SwaggerConfig2 {
    ...
    String authLink="http://localhost:8081/auth";
    String clientId="implicit-flow-client";
    String clientSecret="";
...
/*        authorizationScopeList.add(new AuthorizationScope("trust", "trust all"));*/
        ...
        LoginEndpoint loginEndpoint=new LoginEndpoint(authLink+"/oauth/authorize");
...
/*        authorizationScopes[1] = new AuthorizationScope("trust", "trust all");*/
    ...
    public SecurityConfiguration securityInfo() {
        ...
        SecurityConfiguration securityConfiguration1 = new SecurityConfiguration(clientId, "test", "", "", "", ApiKeyVehicle.HEADER, "", " ");
        SecurityConfiguration securityConfiguration = new SecurityConfiguration(clientId, "test", "", "", "", ApiKeyVehicle.HEADER, "", " ");
